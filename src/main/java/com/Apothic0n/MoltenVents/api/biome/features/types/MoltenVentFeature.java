...
public class MoltenVentFeature extends Feature<MoltenVentConfiguration> {
    ...
    private void placeStraight(WorldGenLevel worldGenLevel, Random random, BlockPos blockPos, BlockStateProvider blockStateProvider, int minRadius, int maxRadius, double probability, @Nullable BlockStateProvider decorate) {
        minRadius--;
    ...
    private void placeDiagonal(WorldGenLevel worldGenLevel, Random random, BlockPos blockPos, BlockStateProvider blockStateProvider, int minRadius, int maxRadius, double probability, @Nullable BlockStateProvider decorate) {
        minRadius--;
        for (int radius = minRadius; radius < maxRadius; radius++) {
    ...
    private void placePartialDiagonal(WorldGenLevel worldGenLevel, Random random, BlockPos blockPos, BlockStateProvider blockStateProvider, int radius, double probability, @Nullable BlockStateProvider decorate) {
        placeBlock(worldGenLevel, random, blockPos.north(radius).east(), blockStateProvider, probability, decorate);
        placeBlock(worldGenLevel, random, blockPos.north(radius).west(), blockStateProvider, probability, decorate);
        placeBlock(worldGenLevel, random, blockPos.south(radius).west(), blockStateProvider, probability, decorate);
        placeBlock(worldGenLevel, random, blockPos.south(radius).east(), blockStateProvider, probability, decorate);
    ...
    private void placeBlock(WorldGenLevel worldGenLevel, Random random, BlockPos blockPos, BlockStateProvider blockStateProvider, double probability, @Nullable BlockStateProvider decorate) {
