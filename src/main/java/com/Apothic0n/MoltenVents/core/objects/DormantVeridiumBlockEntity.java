...
public class DormantVeridiumBlockEntity extends BlockEntity {
    public DormantVeridiumBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(MoltenBlockEntities.DORMANT_VERIDIUM_BLOCK_ENTITY.get(), blockPos, blockState);
    }
        ...
        if (!level.isClientSide) {
            ...
            if (serverLevel != null) {
                ...
                if (blockAbove.is(Blocks.TNT)) {
                    ...
                    level.setBlock(blockPos, MoltenBlocks.MOLTEN_VERIDIUM.get().defaultBlockState(), UPDATE_ALL);
                }
            }
        }
    }
