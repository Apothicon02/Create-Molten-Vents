...
public class DormantCrimsiteBlockEntity extends BlockEntity {
    public DormantCrimsiteBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(MoltenBlockEntities.DORMANT_CRIMSITE_BLOCK_ENTITY.get(), blockPos, blockState);
    }
        ...
        if (!level.isClientSide) {
            ...
            if (serverLevel != null) {
                ...
                if (blockAbove.is(Blocks.TNT)) {
                    ...
                    level.setBlock(blockPos, MoltenBlocks.MOLTEN_CRIMSITE.get().defaultBlockState(), UPDATE_ALL);
                }
            }
        }
    }
